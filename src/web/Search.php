...
<head>
    ...
    <script src="../js/searchSearch.js"></script>
...
<body>
    ...
    <main>
        ...
        <div class="col-12  bg-light text-dark p-4 mb-4">
            <input type="radio" name="filter" val="byTitle" checked>filter by title<br>
            <input class="inputBox" type="text" id="titleSearcher"><br>
            <input type="radio" name="filter" val="byDescription">filter by description<br>
            <textarea class="inputBox" rows="3" cols="60" id="descriptionSearcher"></textarea><br>
