...
<body>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="MyPhoto.php">
                        ...
                        <a class="dropdown-item  active" href="Upload.php">
                        ...
                        <a class="dropdown-item" href="Favourite.php">
    ...
    <main>
        ...
        <form class="col-12  bg-light text-dark p-4 mb-4" enctype="multipart/form-data" action="../php/uploadDownload.php" method="post" id="form">
            <div class="col-12  bg-light text-dark p-4 mb-4" id="photoUploadFrame">
                    <input type="file" value="" name="file" id = "input_file" accept="image/gif,image/jpeg,image/jpg,image/png" onchange="imgPreview(this)" >
                <img class="photoUpload img-fluid" id="imageUpload">
            </div>
            <input class="inputBox" placeholder="Title" type="text" name="title" id="titleBox"><br>
            <textarea class="inputBox" rows="5" cols="60" placeholder="Description" name="description" id="descriptionBox"></textarea><br>
                <select class="select" name="content" id="contents">
                ...
                <select class="select" name="country" id="countries">
                    ...
                    <script src="../js/browseCountriesSelect.js"></script>
                </select>
    ...
    <!-- Optional JavaScript -->
    <script src="../js/uploadSubmit.js"></script>
