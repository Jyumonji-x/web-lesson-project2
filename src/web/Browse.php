...
<head>
    ...
    <script src="../js/browseResultShower.js"></script>
    <script src="../js/browseCitiesSelect.js"></script>
    <script src="../js/browseHotSelectAndFilter.js"></script>
    <script src="../js/browseCountriesSelect.js"></script>
    <script src="../js/browseSearchFilter.js"></script>
    <script src="../js/browseChooserFilter.js"></script>
...
<body class="body">
    ...
    <main>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4  bg-light text-dark m-4 p-4">
                        <input class="form-control mr-sm-2" placeholder="Search" aria-label="Search" id="searchInput">
                        <a class="btn btn-outline-success my-2 my-sm-0" id="searchBtn">Search</a>
                    <div class="list-group" id="hotTags">

                    </div>
                </div>
                <div class="col  bg-light text-dark m-4 p-4">
                    <form id="filterForm">
                        <select class="select" id="contents">
                        ...
                        <a class="btn btn-outline-success my-2 my-sm-0" id="chooserFilterBtn">Filter</a>
                   </form>
