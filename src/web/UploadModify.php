...
<body>
    ...
    <main>
        ...
        <div class="col-12  bg-light text-dark p-4 mb-4" id="photoUploadFrame">
               <div class="photoUpload">
                   <img class="img-fluid" id="modifiedPhoto">
               </div>
        </div>
        <div class="col-12  bg-light text-dark p-4 mb-4">
            <input class="inputBox" placeholder="Title" type="text" id="titleBox"><br>
            <textarea class="inputBox" rows="5" cols="60" placeholder="Description" id="descriptionBox"></textarea><br>
            <form id="filterForm">
    ...
    <!-- Optional JavaScript -->
    <script src="../js/uploadModifyShower.js"></script>
    <script src="../js/uploadModifyChanger.js"></script>
